...
const sortRows = (rows: MiningPriceRow[], key: SortKey, dir: SortDir): MiningPriceRow[] => {
 ...
 */
const ratioColor = (value: number, min: number, max: number): string => {
...
const columnRange = (rows: MiningPriceRow[], key: SortKey): { min: number; max: number } => {
...
const formatIsk = (value: number, unit: string): string => {
...
export const MiningPricesTable = ({ rows }: { rows: MiningPriceRow[] }) => {
...
export { MiningPricesTable as default };
